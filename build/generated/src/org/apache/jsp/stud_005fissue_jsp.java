...
public final class stud_005fissue_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 int i; 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <a href = \"main2.jsp\"> Home </a>\n");
      out.write("                <a href = \"stud_bookdetails.jsp\"> Search Book </a>\n");
      out.write("                <a href = \"stud_issuedetails.jsp\"> Issued Book Details </a>\n");
      out.write("                <a href = \"stud_return.jsp\"> Return Book </a>\n");
      out.write("                <a href = \"stud_chng.jsp\"> Change Password </a>\n");
      ...
      out.write("                \n");
      out.write("                <td>\n");
      out.write("                    <input type=\"text\" name=\"txt_avl\" width=\"100%\" value=\"1\" />\n");
      out.write("                </td>\n");
      out.write("            </tr>\n");
      out.write("            \n");
      out.write("            <tr>\n");
    ...
    if(request.getParameter("btn_issue")!=null)
    {
        try
        {
            ...
            if(rs.next())
            {
                //ResultSet x = st.executeQuery("select * from stud_details where sid = '"+id+"' and sname = '"+name+"' ");
                //if(x.next())
                {
                    bn = rs.getString(2);
                    if(bname.equals(bn))
                ...
                /* else
                {
                    out.println("<h1> Student ID or Name is incorrect. </h1>");
                } */   
            }
            else
            {
